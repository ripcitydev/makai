...
- A few of the hardest problems were the failure recovery, and the handling of mid-flight cancellations. During the discovery phase it became evident Temporal would mitigate these issues.
